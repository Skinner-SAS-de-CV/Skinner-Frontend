  ...
  return (
    <NavbarProvider>
      <Navbar {...props}>
        ...
        <NavbarGap />
        <NavbarSection>
          <NavbarItem className="md:text-md hover:bg-surface-800 hover:text-blue-400 transition-colors duration-200" href="/" isCurrent>
            Home
          </NavbarItem>
          <NavbarItem className="md:text-md hover:bg-surface-800 hover:text-blue-400 transition-colors duration-200" href="/about">Quiénes Somos</NavbarItem>
          <NavbarItem className="md:text-md hover:bg-surface-800 hover:text-blue-400 transition-colors duration-200" href="/companies">Empresas</NavbarItem>
          <NavbarItem className="md:text-md hover:bg-surface-800 hover:text-blue-400 transition-colors duration-200" href="/candidate/home">Candidatos</NavbarItem>
          <SignedOut>
          ...
          <SignedIn>
            {
              user?.publicMetadata.role !== "recruiter" && (
                <NavbarItem className="md:text-md hover:bg-surface-800 hover:text-blue-400 transition-colors duration-200" href="/candidate/analyze">Analizar CV</NavbarItem>
              )
            }
            {(user?.publicMetadata.role === "recruiter" || user?.publicMetadata.role === "admin") && (
              <Menu>
                ...
                <MenuContent popover={{ className: "border-0" }} className="bg-surface-800 text-white min-w-(--trigger-width) sm:min-w-56" items={categories}>
                  {(item) => (
                    <MenuItem className="sm:text-md bg-surface-800 hover:text-blue-400 transition-colors duration-200" id={item.id} textValue={item.label} href={item.url}>
                      {item.label}
                    </MenuItem>
                  )}
                </MenuContent>
