...
const features = [
  {
    ...
    description:
      "Nuestros algoritmos avanzados de IA brindan un analisis profundo de la experiencia y conocimientos de los candidatos a evaluar, asegurando que puedan cumplir con las exigencias del puesto.",
    image: "/analisis.jpg",
  },
  {
